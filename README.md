...
An Android APK is available for download from the [GitHub Releases](https://github.com/clinuxrulz/solid-2-playground/releases) section. Install it directly on your Android device for an offline-capable experience.
